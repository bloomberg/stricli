    ...
    plugins: [
        ...
        [
            "@signalwire/docusaurus-plugin-llms-txt",
            {
                ...
                llmsTxt: {
                    siteTitle: "Stricli",
                    siteDescription: "Build complex CLIs with type safety and no dependencies",
                    includeBlog: false,
                    includePages: false,
            ...
            links: [
                {
                    ...
                    items: [
                        ...
                        {
                            label: "llms.txt",
                            // Generated by the llms-txt plugin in postBuild, so it is not a known
                            // Docusaurus route. The pathname:// prefix emits the link verbatim
                            // (baseUrl included) and skips SPA routing + broken-link checking.
                            to: "pathname:///stricli/llms.txt",
                        },
                    ],
                },
                {
