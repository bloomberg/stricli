...
The common issues with these alternatives can be reframed as a set of language-agnostic guiding principles that should be considered in addition to [clig.dev](https://clig.dev) when analyzing a CLI framework.
