...
The parameters object is a specification of all of the parameters (arguments and flags) that the command should accept. For more information about this specification, check out the section on [argument parsing](../argument-parsing/index.mdx).
...
import HelpTextDocumentationCode from "./examples/help-text-documentation.txt";

<StricliPlayground>{HelpTextDocumentationCode}</StricliPlayground>
