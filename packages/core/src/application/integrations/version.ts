...
import type { ApplicationHook, StricliIntegration, LifecycleHooks } from "../integration";
 ...
 */
export type VersionIntegrationConfiguration =  Omit<AdditionalFlag, "name" | "aliases" | "global"> & {
    /**
...
/**
 * This integration provides a `--version` flag for all commands, which prints the current version of the application and exits.
